<template>
  <div class="chat-container">
    ...
    <div class="chat-sidebar" :class="{ 
      ...
      'mobile-sidebar-closed': isMobile && sidebarCollapsed
    }">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <select v-model="newConversation.type" class="form-select">
              ...
              <option value="group">Team Chat</option>
            </select>
          </div>
          ...
          <div v-if="newConversation.type === 'group'" class="form-group">
            <label class="form-label">Team Chat Name</label>
            <input v-model="newConversation.name" type="text" class="form-input" placeholder="Enter team chat name">
          </div>
...
const handleReactionToggle = async (messageId, emoji) => {
  try {
    ...
    // The message will be updated via socket
  } catch (error) {
...
const getConversationName = (conversation) => {
  ...
  if (conversation.type === 'direct' && conversation.participants && currentUser) {
...
const handleTypingStart = () => {
  if (socket.value && selectedConversation.value && currentUser) {
