  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
        ...
        <div class="flex justify-between items-center h-16">
          <div class="flex items-center">
            <div class="flex-shrink-0">
              <h1 class="text-2xl font-bold text-gray-900">Linton Portals</h1>
            </div>
          </div>
    ...
    <div class="relative overflow-hidden">
      <div class="max-w-7xl mx-auto">
        <div class="relative z-10 pb-8 bg-gradient-to-br from-blue-50 via-white to-indigo-50 sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
          <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div class="sm:text-center lg:text-left">
              <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span class="block xl:inline">Your Work,</span>
                <span class="block text-indigo-600 xl:inline">Simplified</span>
              </h1>
              <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                Streamline your workflow with our comprehensive employee portal. Track time, manage tasks, collaborate with your team, and boost productivity like never before.
              </p>
              <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                <template v-if="!isAuthenticated">
                  <div class="rounded-md shadow">
                    <router-link
                      to="/login"
                      class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10 transition-colors duration-200"
                    >
                      Get Started
                    </router-link>
                  </div>
                  <div class="mt-3 sm:mt-0 sm:ml-3">
                    <a
                      href="#features"
                      class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 md:py-4 md:text-lg md:px-10 transition-colors duration-200"
                    >
                      Learn More
                    </a>
                  </div>
      ...
      <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <div class="h-56 w-full bg-gradient-to-r from-indigo-400 to-purple-500 sm:h-72 md:h-96 lg:w-full lg:h-full flex items-center justify-center">
          <div class="text-white text-center">
            ...
            <p class="text-xl font-semibold">Employee Portal</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="lg:text-center">
          ...
          <p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
            Everything you need to excel at work
          </p>
          <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
            From time tracking to project management, we've got all the tools you need to stay productive and organized.
          </p>
        </div>
        ...
        <div class="mt-10">
          <div class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
            <div class="relative">
              ...
              <p class="ml-16 text-lg leading-6 font-medium text-gray-900">Time Tracking</p>
              <p class="mt-2 ml-16 text-base text-gray-500">
                Track your work hours with precision. Start, pause, and stop timers with ease. Generate detailed reports for better time management.
              </p>
            </div>
            ...
            <div class="relative">
              ...
              <p class="mt-2 ml-16 text-base text-gray-500">
                Organize your tasks with our intuitive interface. Set priorities, add descriptions, and track progress in real-time.
              </p>
            </div>
            ...
            <div class="relative">
              ...
              <p class="mt-2 ml-16 text-base text-gray-500">
                Work seamlessly with your team. Share updates, collaborate on projects, and stay connected with real-time notifications.
              </p>
            </div>
            ...
            <div class="relative">
              ...
              <p class="mt-2 ml-16 text-base text-gray-500">
                Get insights into your productivity with detailed analytics. Track your performance and identify areas for improvement.
              </p>
            </div>
          </div>
        </div>
    ...
    <div class="bg-indigo-700">
      <div class="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
        <h2 class="text-3xl font-extrabold text-white sm:text-4xl">
          ...
          <span class="block">Start using the Employee Portal today.</span>
        </h2>
        <p class="mt-4 text-lg leading-6 text-indigo-200">
          Join thousands of employees who have already transformed their work experience with our comprehensive portal.
        </p>
        <router-link
          to="/login"
      ...
      <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
          <div class="space-y-8 xl:col-span-1">
            <h3 class="text-2xl font-bold text-white">Linton Portals</h3>
            <p class="text-gray-300 text-base">
              Empowering teams with powerful tools for productivity and collaboration.
            </p>
          </div>
        ...
        <div class="mt-12 border-t border-gray-700 pt-8">
          <p class="text-base text-gray-400 xl:text-center">
            &copy; 2024 Linton Portals. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
