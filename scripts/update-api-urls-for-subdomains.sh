...
# Update API URLs in task definitions for subdomain approach
# This script updates the VITE_API_URL to use api.linton-tech.com

set -e

echo "🔧 Updating API URLs for subdomain approach..."

# API URL for subdomain approach
API_URL="https://api.linton-tech.com"
...
update_task_definition "linton-client-portal" 15

echo "📦 Updating employee portal..."
update_task_definition "linton-employee-portal" 13

echo "📦 Updating admin panel..."
update_task_definition "linton-admin-panel" 13
